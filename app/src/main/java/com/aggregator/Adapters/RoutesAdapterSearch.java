...
/**
 * Created by Pranav Mittal on 9/4/2015.
 * Appslure WebSolution LLP
 * www.appslure.com
 */
public class RoutesAdapterSearch extends BaseExpandableListAdapter {
    ...
    public RoutesAdapterSearch(Context context, List<String> listDataHeader,
