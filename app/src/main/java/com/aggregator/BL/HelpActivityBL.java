...
public class HelpActivityBL {
    ...
    private String fetRecord(String userId,String msg)
    {
        ...
        //http://appslure.in/loop/webservices/loop1/help.php?user_id=11&comment=hghghghgh;

        String url="user_id="+userId+"&comment="+msg;

        try
        {
            URI uri = new URI("http", "www.appslure.in", "/loop/webservices/loop1/help.php",url, null);
    ...
    public String validate(String strValue)
    {
        ...
        try {
            ...
            result=(Long)jsonObject1.get("result");
